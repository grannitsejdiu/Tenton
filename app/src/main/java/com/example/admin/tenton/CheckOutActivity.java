...
//        final double tentonLongitude = 21.104819;
        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ActivityCompat.checkSelfPermission(CheckOutActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)
                        != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(CheckOutActivity.this,
                        android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    if (Build.VERSION.SDK_INT >= 23 && ((ContextCompat.checkSelfPermission(CheckOutActivity.this,
                            android.Manifest.permission.ACCESS_COARSE_LOCATION)) != PackageManager.PERMISSION_GRANTED)) {
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("CheckOut Page") // TODO: Define a title for the content shown.
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(CheckOutActivity.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
